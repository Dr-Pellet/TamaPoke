...
object TestFixtures {
    ...
    val dex = DexTable(
        entries = listOf(
            DexEntry(1, "bulbasaur", "BULBASAUR", "planta", "#3C49", 2, 16, Rarity.COMMON, 45, 49, 49, 45, 2),
            ...
            DexEntry(4, "charmander", "CHARMANDER", "fuego", "#EA87", 5, 16, Rarity.COMMON, 39, 52, 43, 65, 3),
